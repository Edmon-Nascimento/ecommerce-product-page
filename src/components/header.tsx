...
function Header({ cart, onDeleteCart }: HeaderProps) {
  ...
  return (
    <header className="p-5 max-w-7xl relative m-auto select-none ">
      <section className="flex justify-between w-full items-center">
        <div className="lg:flex lg:items-center lg:gap-5">
          ...
          >
            <div
              className="flex flex-col pt-30 pl-8 gap-5
                          lg:flex-row lg:pt-0"
            >
        ...
        <div className="flex items-center gap-5">
          <button onClick={() => setIsCartOpen((prev) => !prev)}>
            <div className="relative">
              ...
              <p className="absolute -top-2 left-2 text-white bg-orange-600 p-1 rounded-full size-5 flex items-center justify-center">
                {cart}
              </p>
            </div>
          </button>
      ...
      <div
        ...
        } min-h-50 max-h-fit w-11/12 max-w-[95%] rounded-lg bg-white absolute z-50 top-22 left-1/2 -translate-x-1/2 p-5 lg:max-w-md lg:left-auto lg:right-0 lg:translate-x-0 shadow-2xl border border-black/10`}
      >
        ...
        {cart == 0 ? (
          ...
          <div>
            ...
            <button
              className="bg-orange-500 p-3 w-full font-bold text-lg rounded-lg"
              onClick={() => {
                handleCheckout();
                onDeleteCart();
              }}
